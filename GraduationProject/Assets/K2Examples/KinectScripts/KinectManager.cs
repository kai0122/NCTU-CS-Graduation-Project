	...
	void Update() 
	{
		if(kinectInitialized)
		{
            ...
            if (avatarControllers.Count == 0)
            {
                ...
                {
                    //				if(typeof(AvatarController).IsAssignableFrom(monoScript.GetType()) && monoScript.enabled)
                    if ((monoScript is AvatarController) && monoScript.enabled && monoScript.name == "U_CharacterFront(Clone)1")
                    {
            ...
            if (avatarControllers.Count == 1)
            {
                ...
                {
                    //				if(typeof(AvatarController).IsAssignableFrom(monoScript.GetType()) && monoScript.enabled)
                    if ((monoScript is AvatarController) && monoScript.enabled && monoScript.name == "U_CharacterFront(Clone)2")
                    {
                        AvatarController avatar = (AvatarController)monoScript;
